...
<h3><?php esc_html_e('Translation settings','wpguppy-lite');?></h3>
<code><?php esc_html_e("Please don't remove or make any change in ",'wpguppy-lite');?><b><?php esc_html_e('((xxx)) for example ((username))','wpguppy-lite');?></b></code>
